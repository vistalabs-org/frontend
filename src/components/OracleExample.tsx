...
import OracleLogicVisualizer from './OracleLogicVisualizer';
...
const OracleExample = () => {
  ...
  return (
    <div>
      {/* Page Header */}
      <div className="mb-8">
        <h1 className="text-3xl font-bold text-gray-900">AI Oracle Resolution System</h1>
      ...
      <div className="mb-6 bg-white rounded-lg shadow-sm p-6 border border-gray-100">
        <div className="flex items-start">
          ...
          <div>
            <h2 className="text-xl font-semibold text-gray-900 mb-2">About the EigenLayer AI Oracle</h2>
      ...
      <div className="mb-6">
        <div className="bg-white rounded-lg shadow-sm border border-gray-100 p-1 inline-flex">
          <button
            className={`px-4 py-2 rounded text-sm font-medium ${!showResolved ? 'bg-blue-500 text-white' : 'text-gray-700 hover:bg-gray-100'} transition-colors`}
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="bg-white rounded-lg shadow-sm p-6 border border-gray-100">
            <div className="flex items-center mb-4">
              ...
              <h3 className="font-medium text-lg text-gray-900">Smart Contract Architecture</h3>
            </div>
          ...
          <div className="bg-white rounded-lg shadow-sm p-6 border border-gray-100">
            <div className="flex items-center mb-4">
              ...
              <h3 className="font-medium text-lg text-gray-900">AI Agent Implementation</h3>
            </div>
            <p className="text-gray-700 text-sm">
          ...
          <div className="bg-white rounded-lg shadow-sm p-6 border border-gray-100">
            <div className="flex items-center mb-4">
              ...
              <h3 className="font-medium text-lg text-gray-900">Consensus Mechanism</h3>
            </div>
            <p className="text-gray-700 text-sm">
      ...
      <div className="bg-white rounded-lg shadow-sm p-6 border border-gray-100 mb-8">
        ...
        <div className="space-y-6">
          <div className="border-b border-gray-200 pb-4">
            <h3 className="font-medium text-lg text-gray-900 mb-2">What is an oracle?</h3>
            <p className="text-gray-700">
          ...
          <div className="border-b border-gray-200 pb-4">
            <h3 className="font-medium text-lg text-gray-900 mb-2">Why use AI for oracles?</h3>
            <p className="text-gray-700">
          ...
          <div className="border-b border-gray-200 pb-4">
            <h3 className="font-medium text-lg text-gray-900 mb-2">How are disputes handled?</h3>
            <p className="text-gray-700">
          ...
          <div>
            <h3 className="font-medium text-lg text-gray-900 mb-2">What happens if data sources conflict?</h3>
            <p className="text-gray-700">
